...
const MoviesData = [
  {id: 1, to: '1', title: 'app.MoviesData.Title_WithKids', subtitle: 'app.MoviesData.Subtitle_WithKids', text: '', src: `${ForFamaly}`, movies: [
  ...
  {id: 2, to: '2', title: 'app.MoviesData.Title_YouthMovies', subtitle: 'app.MoviesData.Subtitle_YouthMovies', text: '', src: `${ForCompany}`,  movies: [
  ...
  {id: 3, to: '3', title: 'app.MoviesData.Title_RomanticMovies', subtitle: 'app.MoviesData.Subtitle_RomanticMovies', text: '', src: `${Romantical}`, movies: [
  ...
  {id: 6, to: '6', title: 'app.MoviesData.Title_Thrillers', subtitle: 'app.MoviesData.Subtitle_Thrillers', text: '', src: `${Thrillers}`, movies: [
  ...
  {id: 7, to: '7', title: 'app.MoviesData.Title_Disasters', subtitle: 'app.MoviesData.Subtitle_Disasters', text: '', src: `${Catastrophes}`, movies: [
  ...
  {id: 8, to: '8', title: 'app.MoviesData.Title_AboutSpace', subtitle: 'app.MoviesData.Subtitle_AboutSpace', text: '', src: `${Space}`, movies: [
  ...
  {id: 9, to: '9', title: 'app.MoviesData.Title_AmericanSeries', subtitle: 'app.MoviesData.Subtitle_AmericanSeries', text: '', src: `${ForeignSeries}`, movies: [
  ...
  {id: 10, to: '10', title: 'app.MoviesData.Title_AdventureMovies', subtitle: 'app.MoviesData.Subtitle_AdventureMovies', text: '', src: `${Adventures}`, movies: [
